...
class DatabaseManager {
    ...
    async initializeTables() {
        ...
        const migrations = [
            ...
            `CREATE TABLE IF NOT EXISTS user_stocks (user_id ${INT}, stock_symbol ${TEXT}, shares ${INT} DEFAULT 0, invested_amount ${INT} DEFAULT 0, PRIMARY KEY (user_id, stock_symbol))`,
            `ALTER TABLE user_stocks ADD COLUMN stock_symbol ${TEXT}`,
